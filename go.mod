module github.com/PingCAP-QE/NaglfarCloud

go 1.16

require (
	k8s.io/api v0.19.8
	k8s.io/apiextensions-apiserver v0.19.8 // indirect
...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.19.9-rc.0
...
replace k8s.io/controller-manager => k8s.io/controller-manager v0.19.9-rc.0
